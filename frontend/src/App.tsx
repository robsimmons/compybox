...
const options = createListCollection({
  items: [
    ...
    { label: "Redefine an axiom", value: "simple-redefine-propext" },
    { label: "Plausible-looking misuse of native", value: "simple-plausible-native" },
    { label: "Bad natural number", value: "simple-bad-nat" },
    { label: "Making a malformed Expr", value: "simple-malformed-expr" },
    { label: "Change Type of Theorem", value: "simple-exploit" },
    { label: "Change Type of Theorem (module)", value: "simple-exploit-module" },
